...
async def create_purchase_requisition(
    ...
    for item_data in pr_in.items:
        item = PurchaseRequisitionItem(
            ...
            sku=item_data.sku,
            sub_item_code=item_data.sub_item_code,
...
async def list_purchase_requisitions(
    ...
    for pr in prs:
        pr_dict = {
            ...
            "delivery_type": getattr(pr, 'delivery_type', 'WAREHOUSE') or 'WAREHOUSE',
            ...
            "delivery_address": getattr(pr, 'delivery_address', None),
    ...
    if update_data.items is not None:
        ...
        for item_data in update_data.items:
            ...
            pr_item = PurchaseRequisitionItem(
                ...
                sku=item_dict["sku"],
                sub_item_code=item_dict.get("sub_item_code"),
...
async def convert_requisition_to_po(
    ...
    for pr_item in pr.items:
        ...
        po_item = PurchaseOrderItem(
            ...
            sku=pr_item.sku,
            sub_item_code=pr_item.sub_item_code,
...
async def create_purchase_order(
    ...
    po = PurchaseOrder(
        po_number=po_number,
        po_date=today,
        po_type=getattr(po_in, 'po_type', 'INVENTORY') or 'INVENTORY',
        vendor_id=vendor.id,
        vendor_name=vendor.name,
        vendor_gstin=vendor.gstin,
        delivery_type=delivery_type,
        ...
        capex_request_id=getattr(po_in, 'capex_request_id', None),
    ...
    for item_data in po_in.items:
        ...
        item = PurchaseOrderItem(
            ...
            product_id=item_data.product_id,
            variant_id=item_data.variant_id,
            asset_category_id=getattr(item_data, 'asset_category_id', None),
            product_name=item_data.product_name,
            sku=item_data.sku,
            sub_item_code=item_data.sub_item_code,
    ...
    if items_data is not None:
        ...
        for item_data in items_data:
            ...
            item = PurchaseOrderItem(
                ...
                sub_item_code=item_data.get('sub_item_code'),
